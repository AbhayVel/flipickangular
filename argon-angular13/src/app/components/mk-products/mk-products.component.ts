...
@Component({
  selector: 'qdn-mk-products',
  templateUrl: './mk-products.component.html',
  styleUrls: ['./mk-products.component.css']
})
export class MkProductsComponent implements OnInit {
  ...
  categoryChanges(gridChanges:any,eve:any){
  ...
  ngOnInit(): void {
    ...
    this.filterObject.category = [...new Set(this.products.map(item => item.category))];
    console.log(this.filterObject.category);
    //console.log(unique);
